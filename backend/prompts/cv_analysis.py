...
* Cực kỳ quan trọng: Viết nội dung hoàn toàn bằng tiếng Việt có dấu (UTF-8), TUYỆT ĐỐI KHÔNG tự động chuyển đổi sang dạng ký tự unicode escape (như \\uXXXX). Chỉ escape các dấu ngoặc kép ở bên trong chuỗi giá trị (dùng \" thay vì ") và dấu backslash (\) nếu có.
"""
